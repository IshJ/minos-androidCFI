...
import static de.tcrass.minos.MainActivity.groundTruthValues;
import static de.tcrass.minos.MainActivity.sideChannelValues;
...
//        }
        ...
        if(sideChannelValues!=null&&sideChannelValues.size()!=0) {
            ...
            for (de.tcrass.minos.SideChannelValue sideChannelValue:sideChannelValues) {
                values.put(de.tcrass.minos.SideChannelContract.Columns.SYSTEM_TIME,
                        sideChannelValue.getSystemTime());
                values.put(de.tcrass.minos.SideChannelContract.Columns.COUNT,
                        sideChannelValue.getCount());
                values.put(de.tcrass.minos.SideChannelContract.Columns.SCAN_TIME,
                        sideChannelValue.getScanTime());
                values.put(de.tcrass.minos.SideChannelContract.Columns.ADDRESS,
                        sideChannelValue.getAddress());

                long out =  db.insert(de.tcrass.minos.SideChannelContract.TABLE_NAME, null, values);

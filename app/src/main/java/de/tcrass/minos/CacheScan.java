...
import static de.tcrass.minos.JobInsertRunnable.insert_locker;
...
//            }
            ArrayList<de.tcrass.minos.SideChannelValue> scvs = new ArrayList<de.tcrass.minos.SideChannelValue>();
            // Store these data into an array, they will be save in a database eventually.
            for (int i = 0; i < times.length; i++) {
//                if(logs[i]>120){
//                    continue;
//                }
                de.tcrass.minos.SideChannelValue sideChannelValue = new de.tcrass.minos.SideChannelValue();
